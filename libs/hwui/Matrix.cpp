...
void Matrix4::dump() const {
    ALOGD("Matrix4[");
    ALOGD("  %f %f %f %f", data[0], data[4], data[ 8], data[12]);
    ALOGD("  %f %f %f %f", data[1], data[5], data[ 9], data[13]);
    ALOGD("  %f %f %f %f", data[2], data[6], data[10], data[14]);
    ALOGD("  %f %f %f %f", data[3], data[7], data[11], data[15]);
    ALOGD("]");
}
